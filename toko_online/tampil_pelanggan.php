...
");
        ...
        <tr>
    <td><?=$no?></td>
    <td><?=$data_toko['id_pelanggan']?></td>
    <td><?=$data_toko['nama_pelanggan']?></td>
    <td><?=$data_toko['alamat']?></td>
    <td><?=$data_toko['telp']?></td>
  
    <td>
                        <a href="ubah_pelanggan.php?id_pelanggan=<?= $data_toko['id_pelanggan'] ?>" class="btn btn-success">Ubah</a> 
                        | 
                        <a href="hapus_pelanggan.php?id_pelanggan=<?= $data_toko['id_pelanggan'] ?>"
